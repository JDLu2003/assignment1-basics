...
def run_embedding(
    ...
    """
    import cs336_basics.utils as utils
    model =  utils.Embedding(vocab_size, d_model)
    model.load_state_dict({"weight": weights})
...
def run_swiglu(
    ...
    import cs336_basics.utils as utils
    model = utils.Swiglu(d_model, d_ff)
...
def run_rmsnorm(
    ...
    """
    from cs336_basics.utils import RMSNorm
...
def get_tokenizer(
    ...
    """
    from cs336_basics._rust_ext import BPETokenizer
    ...
    Returns:
        tuple[dict[int, bytes], list[tuple[bytes, bytes]]]:
            ...
            merges:
                ...
                Merges are ordered by order of creation.
    """
    from cs336_basics._rust_ext import train_bpe
